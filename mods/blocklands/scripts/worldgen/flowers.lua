...
local function register_mgv6_flower(flower_name)
	minetest.register_decoration({
		...
		y_max = 30,
		y_min = 1,
		decoration = "blocklife:"..flower_name,
	})
end

local function register_mgv6_mushroom(mushroom_name)
	minetest.register_decoration({
		name = "blocklife:"..mushroom_name,
		deco_type = "simple",
		place_on = {"blocklife:dirt_with_grass"},
		sidelen = 16,
		noise_params = {
		...
		y_max = 30,
		y_min = 1,
		decoration = "blocklife:"..mushroom_name,
		spawn_by = "blocklife:tree",
		num_spawn_by = 1,
	})
end
...
local function register_mgv6_waterlily()
	minetest.register_decoration({
		...
		y_max = 0,
		y_min = 0,
		decoration = "blocklife:waterlily_waving",
		param2 = 0,
		param2_max = 3,
		place_offset_y = 1,
	})
...
local function register_mushroom(mushroom_name)
	minetest.register_decoration({
		name = "blocklife:"..mushroom_name,
		deco_type = "simple",
		place_on = {"blocklife:dirt_with_grass", "blocklife:dirt_with_coniferous_litter"},
		sidelen = 16,
		noise_params = {
			offset = 0,
			scale = 0.006,
