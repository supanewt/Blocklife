...
blockman.doors = blockman.doors or {}
local doors = blockman.doors
blockman.expose_global("doors", doors)
...
minetest.register_alias("doors:hidden", "blocklife:hidden")

local function alias_door(name)
	minetest.register_alias("doors:" .. name, "blocklife:" .. name)
	minetest.register_alias("doors:" .. name .. "_a", "blocklife:" .. name .. "_a")
	minetest.register_alias("doors:" .. name .. "_b", "blocklife:" .. name .. "_b")
	minetest.register_alias("doors:" .. name .. "_c", "blocklife:" .. name .. "_c")
	minetest.register_alias("doors:" .. name .. "_d", "blocklife:" .. name .. "_d")
end

local function alias_trapdoor(name)
	minetest.register_alias("doors:" .. name, "blocklife:" .. name)
	minetest.register_alias("doors:" .. name .. "_open", "blocklife:" .. name .. "_open")
end

local function alias_gate(name)
	minetest.register_alias("doors:" .. name .. "_closed", "blocklife:" .. name .. "_closed")
	minetest.register_alias("doors:" .. name .. "_open", "blocklife:" .. name .. "_open")
end

alias_door("door_wood")
alias_door("door_steel")
alias_door("door_glass")
alias_door("door_obsidian_glass")
alias_trapdoor("trapdoor")
alias_trapdoor("trapdoor_steel")
alias_gate("gate_wood")
...
local function is_doors_upper_node(pos)
	return minetest.get_node(pos).name == "blocklife:hidden"
end
...
minetest.register_node("blocklife:hidden", {
	description = S("Hidden Door Segment"),
	inventory_image = "blocklife_doors_hidden_segment.png^blocklife_invisible_node_overlay.png",
	wield_image = "blocklife_doors_hidden_segment.png^blocklife_invisible_node_overlay.png",
	drawtype = "airlike",
	paramtype = "light",
	paramtype2 = "facedir",
...
function doors.door_toggle(pos, node, clicker)
	...
	if clicker and not blockman.can_interact_with_node(clicker, pos) then
		return false
	end
...
local function can_dig_door(pos, digger)
	replace_old_owner_information(pos)
	return blockman.can_interact_with_node(digger, pos)
end
...
function doors.register(name, def)
	...
	minetest.register_lbm({
		name = ":blocklife:replace_" .. name:gsub(":", "_"),
		...
		action = function(pos, node)
			...
			-- properly place blocklife:hidden at the right spot
			local p3 = p2
			if new.state >= 2 then
				p3 = (p3 + 3) % 4
			end
			...
			minetest.set_node({x = pos.x, y = pos.y + 1, z = pos.z},
				{name = "blocklife:hidden", param2 = p3})
		end
	})
	...
	minetest.register_craftitem(":" .. name, {
		...
		on_place = function(itemstack, placer, pointed_thing)
			...
			if minetest.get_item_group(minetest.get_node(aside).name, "door") == 1 then
				...
				minetest.set_node(above, {name = "blocklife:hidden", param2 = (dir + 3) % 4})
			else
				minetest.set_node(pos, {name = doorname .. "_a", param2 = dir})
				minetest.set_node(above, {name = "blocklife:hidden", param2 = dir})
			end
	...
	if not def.sounds then
		def.sounds = blockman.node_sound_wood_defaults()
	end

	if not def.sound_open then
		def.sound_open = "blocklife_doors_door_open"
	end

	if not def.sound_close then
		def.sound_close = "blocklife_doors_door_close"
	end
	...
	def.mesh = "blocklife_door_a.b3d"
	minetest.register_node(":" .. name .. "_a", table.copy(def))

	def.mesh = "blocklife_door_b.b3d"
...
doors.register("door_wood", {
		tiles = {{name = "blocklife_doors_door_wood.png", backface_culling = true}},
		description = S("Wooden Door"),
		inventory_image = "blocklife_doors_item_wood.png",
...
doors.register("door_steel", {
		tiles = {{name = "blocklife_doors_door_steel.png", backface_culling = true}},
		description = S("Steel Door"),
		inventory_image = "blocklife_doors_item_steel.png",
		protected = true,
		groups = {node = 1, cracky = 1, level = 2},
		sounds = blockman.node_sound_metal_defaults(),
		sound_open = "blocklife_doors_steel_door_open",
		sound_close = "blocklife_doors_steel_door_close",
		gain_open = 0.2,
		gain_close = 0.2,
		recipe = {
...
doors.register("door_glass", {
		tiles = {"blocklife_doors_door_glass.png"},
		description = S("Glass Door"),
		inventory_image = "blocklife_doors_item_glass.png",
		groups = {node = 1, cracky = 3, oddly_breakable_by_hand = 3},
		sounds = blockman.node_sound_glass_defaults(),
		sound_open = "blocklife_doors_glass_door_open",
		sound_close = "blocklife_doors_glass_door_close",
		gain_open = 0.3,
		gain_close = 0.25,
		recipe = {
...
doors.register("door_obsidian_glass", {
		tiles = {"blocklife_doors_door_obsidian_glass.png"},
		description = S("Obsidian Glass Door"),
		inventory_image = "blocklife_doors_item_obsidian_glass.png",
		...
		gain_close = 0.25,
		recipe = {
			{"blocklife:obsidian_glass", "blocklife:obsidian_glass"},
			{"blocklife:obsidian_glass", "blocklife:obsidian_glass"},
			{"blocklife:obsidian_glass", "blocklife:obsidian_glass"},
		},
})
...
function doors.register_door(name, def)
	...
	if not def.tiles then
		if def.protected then
			def.tiles = {{name = "blocklife_doors_door_steel.png", backface_culling = true}}
		else
			def.tiles = {{name = "blocklife_doors_door_wood.png", backface_culling = true}}
		end
...
doors.register_trapdoor("blocklife:trapdoor", {
	description = S("Wooden Trapdoor"),
	inventory_image = "blocklife_doors_trapdoor.png",
	wield_image = "blocklife_doors_trapdoor.png",
	tile_front = "blocklife_doors_trapdoor.png",
	tile_side = "blocklife_doors_trapdoor_side.png",
	gain_open = 0.06,
	gain_close = 0.13,
	groups = {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, door = 1},
})

doors.register_trapdoor("blocklife:trapdoor_steel", {
	description = S("Steel Trapdoor"),
	inventory_image = "blocklife_doors_trapdoor_steel.png",
	wield_image = "blocklife_doors_trapdoor_steel.png",
	tile_front = "blocklife_doors_trapdoor_steel.png",
	tile_side = "blocklife_doors_trapdoor_steel_side.png",
	protected = true,
	sounds = blockman.node_sound_metal_defaults(),
	sound_open = "blocklife_doors_steel_door_open",
	sound_close = "blocklife_doors_steel_door_close",
...
minetest.register_craft({
	output = "blocklife:trapdoor_steel",
	recipe = {
		{"blocklife:steel_ingot", "blocklife:steel_ingot"},
		{"blocklife:steel_ingot", "blocklife:steel_ingot"},
	}
...
function doors.register_fencegate(name, def)
	...
	if not fence.sounds then
		fence.sounds = blockman.node_sound_wood_defaults()
	end

	fence.groups.fence = 1

	local fence_closed = table.copy(fence)
	fence_closed.mesh = "blocklife_doors_fencegate_closed.obj"
	fence_closed._gate = name .. "_open"
	fence_closed._gate_sound = "blocklife_doors_fencegate_open"
	...
	fence_open.mesh = "blocklife_doors_fencegate_open.obj"
	fence_open._gate = name .. "_closed"
	fence_open._gate_sound = "blocklife_doors_fencegate_close"
...
doors.register_fencegate("blocklife:gate_wood", {
	description = S("Apple Wood Fence Gate"),
	texture = "blocklife_wood.png",
...
minetest.register_craft({
	type = "fuel",
	recipe = "blocklife:trapdoor",
	burntime = 7,
})

minetest.register_craft({
	type = "fuel",
	recipe = "blocklife:door_wood",
	burntime = 14,
})

minetest.register_craft({
	type = "fuel",
	recipe = "blocklife:gate_wood_closed",
	burntime = 7,
})
