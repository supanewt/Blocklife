...
function blockman.node_sound_defaults(tbl)
	...
	tbl.footstep = tbl.footstep or
			{name = "", gain = 1.0}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_dug_node", gain = 0.25}
	tbl.place = tbl.place or
			{name = "blocklife_default_place_node_hard", gain = 1.0}
	return tbl
end
...
function blockman.node_sound_stone_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_hard_footstep", gain = 0.2}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_hard_footstep", gain = 1.0}
...
function blockman.node_sound_dirt_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_dirt_footstep", gain = 0.25}
	tbl.dig = tbl.dig or
			{name = "blocklife_default_dig_crumbly", gain = 0.4}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_dirt_footstep", gain = 1.0}
	tbl.place = tbl.place or
			{name = "blocklife_default_place_node", gain = 1.0}
	blockman.node_sound_defaults(tbl)
	return tbl
end
...
function blockman.node_sound_sand_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_sand_footstep", gain = 0.05}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_sand_footstep", gain = 0.15}
	tbl.place = tbl.place or
			{name = "blocklife_default_place_node", gain = 1.0}
	blockman.node_sound_defaults(tbl)
	return tbl
...
function blockman.node_sound_gravel_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_gravel_footstep", gain = 0.25}
	tbl.dig = tbl.dig or
			{name = "blocklife_default_gravel_dig", gain = 0.35}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_gravel_dug", gain = 1.0}
	tbl.place = tbl.place or
			{name = "blocklife_default_place_node", gain = 1.0}
	blockman.node_sound_defaults(tbl)
	return tbl
...
function blockman.node_sound_wood_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_wood_footstep", gain = 0.15}
	tbl.dig = tbl.dig or
			{name = "blocklife_default_dig_choppy", gain = 0.4}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_wood_footstep", gain = 1.0}
	blockman.node_sound_defaults(tbl)
	return tbl
end
...
function blockman.node_sound_leaves_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_grass_footstep", gain = 0.45}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_grass_footstep", gain = 0.7}
	tbl.place = tbl.place or
			{name = "blocklife_default_place_node", gain = 1.0}
	blockman.node_sound_defaults(tbl)
	return tbl
...
function blockman.node_sound_glass_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_glass_footstep", gain = 0.3}
	tbl.dig = tbl.dig or
			{name = "blocklife_default_glass_footstep", gain = 0.5}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_break_glass", gain = 1.0}
	blockman.node_sound_defaults(tbl)
	return tbl
end
...
function blockman.node_sound_ice_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_ice_footstep", gain = 0.15}
	tbl.dig = tbl.dig or
			{name = "blocklife_default_ice_dig", gain = 0.5}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_ice_dug", gain = 0.5}
	blockman.node_sound_defaults(tbl)
	return tbl
end
...
function blockman.node_sound_metal_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_metal_footstep", gain = 0.2}
	tbl.dig = tbl.dig or
			{name = "blocklife_default_dig_metal", gain = 0.5}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_dug_metal", gain = 0.5}
	tbl.place = tbl.place or
			{name = "blocklife_default_place_node_metal", gain = 0.5}
	blockman.node_sound_defaults(tbl)
	return tbl
end
...
function blockman.node_sound_water_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_water_footstep", gain = 0.2}
	blockman.node_sound_defaults(tbl)
	return tbl
end
...
function blockman.node_sound_snow_defaults(tbl)
	tbl = tbl or {}
	tbl.footstep = tbl.footstep or
			{name = "blocklife_default_snow_footstep", gain = 0.2}
	tbl.dig = tbl.dig or
			{name = "blocklife_default_snow_footstep", gain = 0.3}
	tbl.dug = tbl.dug or
			{name = "blocklife_default_snow_footstep", gain = 0.3}
	tbl.place = tbl.place or
			{name = "blocklife_default_place_node", gain = 1.0}
...
blockman.cool_lava = function(pos, node)
	if node.name == "blocklife:lava_source" then
		minetest.set_node(pos, {name = "blocklife:obsidian"})
	else -- Lava flowing
		minetest.set_node(pos, {name = "blocklife:stone"})
	end
	minetest.sound_play("blocklife_default_cool_lava",
...
if minetest.settings:get_bool("enable_lavacooling") ~= false then
	minetest.register_abm({
		label = "Lava cooling",
		nodenames = {"blocklife:lava_source", "blocklife:lava_flowing"},
...
function blockman.get_inventory_drops(pos, inventory, drops)
...
function blockman.grow_cactus(pos, node)
	...
	pos.y = pos.y + 1
	local height = 0
	while node.name == "blocklife:cactus" and height < 4 do
		height = height + 1
		pos.y = pos.y + 1
	...
	minetest.set_node(pos, {name = "blocklife:cactus"})
	return true
end

function blockman.grow_papyrus(pos, node)
	pos.y = pos.y - 1
	local name = minetest.get_node(pos).name
	if name ~= "blocklife:dirt" and
			name ~= "blocklife:dirt_with_grass" and
			name ~= "blocklife:dirt_with_dry_grass" and
			name ~= "blocklife:dirt_with_rainforest_litter" and
			name ~= "blocklife:dry_dirt" and
			name ~= "blocklife:dry_dirt_with_dry_grass" then
		return
	end
	...
	pos.y = pos.y + 1
	local height = 0
	while node.name == "blocklife:papyrus" and height < 4 do
		height = height + 1
		pos.y = pos.y + 1
		node = minetest.get_node(pos)
	end
	...
	minetest.set_node(pos, {name = "blocklife:papyrus"})
	return true
end

minetest.register_abm({
	label = "Grow cactus",
	nodenames = {"blocklife:cactus"},
	neighbors = {"group:sand"},
	interval = 12,
	chance = 83,
	action = function(...)
		blockman.grow_cactus(...)
	end
})

minetest.register_abm({
	label = "Grow papyrus",
	nodenames = {"blocklife:papyrus"},
	-- Grows on the dirt and surface dirt nodes of the biomes papyrus appears in,
	-- including the old savanna nodes.
	-- 'blocklife:dirt_with_grass' is here only because it was allowed before.
	neighbors = {
		"blocklife:dirt",
...
function blockman.dig_up(pos, node, digger, max_height)
...
function blockman.register_fence(name, def)
	local fence_texture = "blocklife_fence_overlay.png^" .. def.texture ..
...
function blockman.register_fence_rail(name, def)
	local fence_rail_texture = "blocklife_fence_rail_overlay.png^" .. def.texture ..
...
function blockman.register_mesepost(name, def)
	local post_texture = def.texture .. "^blocklife_mese_post_light_side.png^[makealpha:0,0,0"
	local post_texture_dark = def.texture .. "^blocklife_mese_post_light_side_dark.png^[makealpha:0,0,0"
	-- Allow almost everything to be overridden
	local default_fields = {
...
blockman.after_place_leaves = function(pos, placer, itemstack, pointed_thing)
...
local function leafdecay_after_destruct(pos, oldnode, def)
	for _, v in pairs(minetest.find_nodes_in_area(vector.subtract(pos, def.radius),
		...
		if node.param2 ~= 1 and not timer:is_started() then
			timer:start(math.random(5, 15) / 10)
		end
	end
end
...
function blockman.register_leafdecay(def)
	assert(def.leaves)
	assert(def.trunks)
	assert(def.radius)
	...
	minetest.register_abm({
		label = "Leaf decay quick start",
		nodenames = def.leaves,
		interval = 3,
		chance = 2,
		catch_up = false,
...
--
-- Convert blocklife:dirt to something that fits the environment
--

minetest.register_abm({
	label = "Grass spread",
	nodenames = {"blocklife:dirt"},
	neighbors = {
		"air",
		"group:grass",
		"group:dry_grass",
	...
	action = function(pos, node)
		...
		elseif minetest.get_item_group(name, "dry_grass") ~= 0 then
			minetest.set_node(pos, {name = "blocklife:dirt_with_dry_grass"})
		elseif minetest.get_item_group(name, "grass") ~= 0 then
			minetest.set_node(pos, {name = "blocklife:dirt_with_grass"})
		end
	end
})
...
minetest.register_abm({
	label = "Grass covered",
	nodenames = {"group:spreading_dirt_type", "blocklife:dry_dirt_with_dry_grass"},
	interval = 8,
	chance = 50,
	catch_up = false,
	action = function(pos, node)
		...
		if name ~= "ignore" and nodedef and not ((nodedef.sunlight_propagates or
			...
			if node.name == "blocklife:dry_dirt_with_dry_grass" then
				minetest.set_node(pos, {name = "blocklife:dry_dirt"})
			else
				minetest.set_node(pos, {name = "blocklife:dirt"})
			end
		end
	end
})
...
local moss_correspondences = {
	["blocklife:cobble"] = "blocklife:mossycobble",
...
minetest.register_abm({
	label = "Moss growth",
	nodenames = {"blocklife:cobble", "stairs:slab_cobble", "stairs:stair_cobble",
...
function blockman.register_craft_metadata_copy(ingredient, result)
	minetest.register_craft({
		type = "shapeless",
		output = result,
...
function blockman.can_interact_with_node(player, pos)
