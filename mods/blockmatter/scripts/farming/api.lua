...
farming.hoe_on_use = function(itemstack, user, pointed_thing, uses)
	...
	minetest.sound_play("blocklife_default_dig_crumbly", {
		pos = pt.under,
		gain = 0.3,
	}, true)
...
farming.place_seed = function(itemstack, placer, pointed_thing, plantname)
	...
	if placer then
		blockman.log_player_action(placer, "places node", plantname, "at", pt.above)
	end
...
farming.register_plant = function(name, def)
	...
	local tex_name = def.texture_name or mname
	if tex_name:sub(1, 10) ~= "blocklife_" then
		tex_name = "blocklife_" .. tex_name
	end
	...
	minetest.register_node(":" .. mname .. ":seed_" .. pname, {
		...
		sounds = blockman.node_sound_dirt_defaults({
			dig = {name = "", gain = 0},
			dug = {name = "blocklife_default_grass_footstep", gain = 0.2},
			place = {name = "blocklife_default_place_node", gain = 0.25},
		}),
	...
	minetest.register_craftitem(":" .. mname .. ":" .. pname, {
		...
		inventory_image = tex_name .. "_" .. pname .. ".png",
	...
	for i = 1, def.steps do
		...
		minetest.register_node(":" .. mname .. ":" .. pname .. "_" .. i, {
			drawtype = "plantlike",
			waving = 1,
			tiles = {tex_name .. "_" .. pname .. "_" .. i .. ".png"},
			paramtype = "light",
