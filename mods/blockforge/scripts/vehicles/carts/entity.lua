...
local cart_entity = {
	initial_properties = {
		...
		visual = "mesh",
		mesh = "blocklife_carts_cart.b3d",
		visual_size = {x=1, y=1},
		textures = {"blocklife_carts_cart.png"},
	},
...
function cart_entity:on_punch(puncher, time_from_last_punch, tool_capabilities, direction)
	...
	if puncher:get_player_control().sneak then
		...
		if not minetest.is_creative_enabled(puncher:get_player_name())
				or not inv:contains_item("main", "blocklife:cart") then
			local leftover = inv:add_item("main", "blocklife:cart")
...
minetest.register_entity("blocklife:cart", cart_entity)

minetest.register_craftitem("blocklife:cart", {
	description = S("Cart") .. "\n" .. S("(Sneak+Click to pick up)"),
	inventory_image = minetest.inventorycube("blocklife_carts_cart_top.png", "blocklife_carts_cart_front.png", "blocklife_carts_cart_side.png"),
	wield_image = "blocklife_carts_cart_front.png",
	on_place = function(itemstack, placer, pointed_thing)
		...
		if carts:is_rail(pointed_thing.under) then
			minetest.add_entity(pointed_thing.under, "blocklife:cart")
		elseif carts:is_rail(pointed_thing.above) then
			minetest.add_entity(pointed_thing.above, "blocklife:cart")
		else
			return
		end

		minetest.sound_play({name = "blocklife_default_place_node_metal", gain = 0.5},
...
minetest.register_alias("carts:cart", "blocklife:cart")

minetest.register_craft({
	output = "blocklife:cart",
	recipe = {
