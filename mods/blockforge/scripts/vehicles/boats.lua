...
local boat = {
	initial_properties = {
		...
		visual = "mesh",
		mesh = "blocklife_boats_boat.obj",
		textures = {"blocklife_wood.png"},
	},
...
function boat.on_punch(self, puncher)
	...
	if not self.driver then
		...
		if not minetest.is_creative_enabled(name)
				or not inv:contains_item("main", "blocklife:boat") then
			local leftover = inv:add_item("main", "blocklife:boat")
...
minetest.register_entity("blocklife:boat", boat)


minetest.register_craftitem("blocklife:boat", {
	description = S("Boat"),
	inventory_image = "blocklife_boats_inventory.png",
	wield_image = "blocklife_boats_wield.png",
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		boat = minetest.add_entity(pointed_thing.under, "blocklife:boat")
		if boat then
			if placer then
