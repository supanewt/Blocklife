...
function binoculars.update_player_property(player)
	...
	if player:get_inventory():contains_item(
			"main", "blocklife:binoculars") then
		new_zoom_fov = 10
...
minetest.register_craftitem("blocklife:binoculars", {
	description = S("Binoculars") .. "\n" .. S("Use with 'Zoom' key"),
	inventory_image = "blocklife_binoculars_binoculars.png",
	stack_max = 1,
	groups = {tool = 1},
