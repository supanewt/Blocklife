...
blockman.screwdriver = blockman.screwdriver or {}
local screwdriver = blockman.screwdriver
blockman.expose_global("screwdriver", screwdriver)
...
-- Screwdriver
minetest.register_tool("blocklife:screwdriver", {
	description = S("Screwdriver") .. "\n" .. S("(left-click rotates face, right-click rotates axis)"),
	inventory_image = "blocklife_screwdriver.png",
	groups = {tool = 1},
...
minetest.register_alias("blocklife:screwdriver1", "blocklife:screwdriver")
minetest.register_alias("blocklife:screwdriver2", "blocklife:screwdriver")
minetest.register_alias("blocklife:screwdriver3", "blocklife:screwdriver")
minetest.register_alias("blocklife:screwdriver4", "blocklife:screwdriver")


minetest.register_alias("screwdriver:screwdriver", "blocklife:screwdriver")
minetest.register_alias("screwdriver:screwdriver1", "blocklife:screwdriver")
minetest.register_alias("screwdriver:screwdriver2", "blocklife:screwdriver")
minetest.register_alias("screwdriver:screwdriver3", "blocklife:screwdriver")
minetest.register_alias("screwdriver:screwdriver4", "blocklife:screwdriver")
