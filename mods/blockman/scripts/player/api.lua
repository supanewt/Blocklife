...
blockman.player_api = blockman.player_api or {}
local player_api = blockman.player_api
blockman.expose_global("player_api", player_api)
...
function player_api.set_model(player, model_name)
	...
	if model then
		...
		player:set_properties({
			textures = {"blocklife_player.png", "blocklife_player_back.png"},
...
-- Prevent knockback for attached players (after all mods load)
minetest.register_on_mods_loaded(function()
	local old_calculate_knockback = minetest.calculate_knockback
	minetest.calculate_knockback = function(player, ...)
