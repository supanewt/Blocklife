...
local allsounds = {
	["blocklife_env_sounds_water"] = {
		trigger = {"blocklife:water_flowing", "blocklife:river_water_flowing"},
		base_volume = 0.04,
		max_volume = 0.4,
		per_node = 0.004,
	},
	["blocklife_env_sounds_lava"] = {
		trigger = {"blocklife:lava_source", "blocklife:lava_flowing"},
		base_volume = 0,
		max_volume = 0.6,
		per_node = {
			["blocklife:lava_source"] = 0.008,
			["blocklife:lava_flowing"] = 0.002,
		},
	},
}

if minetest.settings:get_bool("river_source_sounds") then
	table.insert(allsounds["blocklife_env_sounds_water"].trigger,
...
local function update_sound(player)
	...
	local eye_height = player:get_properties().eye_height or 0
