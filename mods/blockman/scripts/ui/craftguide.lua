...
local group_stereotypes = {
	dye = "dye:white",
	wool = "blocklife:wool_white",
	coal = "blocklife:coal_lump",
	vessel = "vessels:glass_bottle",
	flower = "blocklife:dandelion_yellow"
}
...
local function groups_to_item(groups)
	if #groups == 1 then
		...
		elseif minetest.registered_items["blocklife:"..group] then
			return "blocklife:"..group
		end
	end
...
local function recipe_fs(fs, data)
	...
	if #data.recipes > 1 then
		table.insert(fs,
			"image_button[5.5,1.6;0.8,0.8;blocklife_craftguide_prev_icon.png;recipe_prev;]"..
			"image_button[6.2,1.6;0.8,0.8;blocklife_craftguide_next_icon.png;recipe_next;]"..
	...
	table.insert(fs, "image[3,1;1,1;blocklife_sfinv_crafting_arrow.png]")
...
local function get_formspec(player)
	...
	table.insert(fs,
		...
		"label[5.8,4.15;"..minetest.colorize("yellow", data.pagenum).." / "..
			data.pagemax.."]"..
		"image_button[2.63,4.05;0.8,0.8;blocklife_craftguide_search_icon.png;search;]"..
		"image_button[3.25,4.05;0.8,0.8;blocklife_craftguide_clear_icon.png;clear;]"..
		"image_button[5,4.05;0.8,0.8;blocklife_craftguide_prev_icon.png;prev;]"..
		"image_button[7.25,4.05;0.8,0.8;blocklife_craftguide_next_icon.png;next;]"..
...
sfinv.register_page("blocklife:craftguide", {
	title = esc(S("Recipes")),
...
minetest.register_alias("mtg_craftguide:craftguide", "blocklife:craftguide")
