...
blockman.creative = blockman.creative or {}
local creative = blockman.creative
blockman.expose_global("creative", creative)
...
-- Override the engine's creative mode function after all mods load
...
-- Don't pick up if the item is already in the inventory (after all mods load)
minetest.register_on_mods_loaded(function()
