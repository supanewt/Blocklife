...
local compat = blockman and blockman.compat
local det_prefix = compat and "blockman_" or ""
...
function creative.init_creative_inventory(player)
	...
	minetest.create_detached_inventory(det_prefix .. "creative_" .. player_name, {
...
function creative.update_creative_inventory(player_name, tab_content)
	...
	local player_inv = minetest.get_inventory({type = "detached", name = det_prefix .. "creative_" .. player_name})
...
local trash = minetest.create_detached_inventory(det_prefix .. "trash", {
...
function creative.register_tab(name, title, items)
	sfinv.register_page("blocklife:" .. name, {
		title = title,
		...
		get = function(self, player, context)
			...
			return sfinv.make_formspec(player, context,
				...
				"label[5.8,4.15;" .. minetest.colorize("#FFFF00", tostring(pagenum)) .. " / " .. tostring(pagemax) .. "]" ..
					[[
						image[4.08,4.2;0.8,0.8;blocklife_creative_trash_icon.png]
						listcolors[#00000069;#5A5A5A;#141318;#30434C;#FFF]
						list[detached:]] .. det_prefix .. [[trash;main;4.02,4.1;1,1;]
						listring[]
						image_button[5,4.05;0.8,0.8;blocklife_creative_prev_icon.png;creative_prev;]
						image_button[7.25,4.05;0.8,0.8;blocklife_creative_next_icon.png;creative_next;]
						image_button[2.63,4.05;0.8,0.8;blocklife_creative_search_icon.png;creative_search;]
						image_button[3.25,4.05;0.8,0.8;blocklife_creative_clear_icon.png;creative_clear;]
					]] ..
				...
				"field[0.3,4.2;2.8,1.2;creative_filter;;" .. esc(inv.filter) .. "]" ..
					"listring[detached:" .. det_prefix .. "creative_" .. player_name .. ";main]" ..
					"list[detached:" .. det_prefix .. "creative_" .. player_name .. ";main;0,0;8,4;" .. tostring(inv.start_i) .. "]" ..
...
minetest.register_alias("creative:all", "blocklife:all")
minetest.register_alias("creative:nodes", "blocklife:nodes")
minetest.register_alias("creative:tools", "blocklife:tools")
minetest.register_alias("creative:craftitems", "blocklife:craftitems")
