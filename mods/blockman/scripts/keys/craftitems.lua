...
minetest.register_craftitem("blocklife:skeleton_key", {
	description = S("Skeleton Key"),
	inventory_image = "blocklife_keys_key_skeleton.png",
	on_use = function(itemstack, user, pointed_thing)
		...
		if secret then
			...
			local new_stack = ItemStack("blocklife:key")
...
minetest.register_craftitem("blocklife:key", {
	description = S("Key"),
	inventory_image = "blocklife_keys_key.png",
...
minetest.register_alias("keys:skeleton_key", "blocklife:skeleton_key")
minetest.register_alias("keys:key", "blocklife:key")
