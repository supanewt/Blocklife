...
function blockman.get_furnace_active_formspec(fuel_percent, item_percent)
	return "size[8,8.5]"..
		"list[context;src;2.75,0.5;1,1;]"..
		"list[context;fuel;2.75,2.5;1,1;]"..
		"image[2.75,1.5;1,1;blocklife_furnace_fire_bg.png^[lowpart:"..
		(fuel_percent)..":blocklife_furnace_fire_fg.png]"..
		"image[3.75,1.5;1,1;blocklife_gui_furnace_arrow_bg.png^[lowpart:"..
		(item_percent)..":blocklife_gui_furnace_arrow_fg.png^[transformR270]"..
...
function blockman.get_furnace_inactive_formspec()
	return "size[8,8.5]"..
		"list[context;src;2.75,0.5;1,1;]"..
		"list[context;fuel;2.75,2.5;1,1;]"..
		"image[2.75,1.5;1,1;blocklife_furnace_fire_bg.png]"..
		"image[3.75,1.5;1,1;blocklife_gui_furnace_arrow_bg.png^[transformR270]"..
		"list[context;dst;4.75,0.96;2,2;]"..
		"list[current_player;main;0,4.25;8,1;]"..
		"list[current_player;main;0,5.5;8,3;8]"..
		"listring[context;dst]"..
...
local function furnace_node_timer(pos, elapsed)
	...
	if items_smelt > 0 then
		-- Play cooling sound
		core.sound_play("blocklife_default_cool_lava",
	...
	if fuel_totaltime ~= 0 then
		...
		formspec = blockman.get_furnace_active_formspec(fuel_percent, item_percent)
		swap_node(pos, "blocklife:furnace_active")
		-- make sure timer restarts automatically
		result = true

		-- Play sound every 5 seconds while the furnace is active
		if timer_elapsed == 0 or (timer_elapsed + 1) % 5 == 0 then
			local sound_id = core.sound_play("blocklife_default_furnace_active",
		...
		formspec = blockman.get_furnace_inactive_formspec()
		swap_node(pos, "blocklife:furnace")
...
local function apply_logger(def)
	blockman.set_inventory_action_loggers(def, "furnace")
	return def
end

core.register_node("blocklife:furnace", apply_logger({
	description = S("Furnace"),
	tiles = {
		"blocklife_furnace_top.png", "blocklife_furnace_bottom.png",
		"blocklife_furnace_side.png", "blocklife_furnace_side.png",
		"blocklife_furnace_side.png", "blocklife_furnace_front.png"
	},
	paramtype2 = "facedir",
	groups = {cracky=2},
	...
	on_blast = function(pos)
		local drops = {}
		blockman.get_inventory_drops(pos, "src", drops)
		blockman.get_inventory_drops(pos, "fuel", drops)
		blockman.get_inventory_drops(pos, "dst", drops)
		drops[#drops+1] = "blocklife:furnace"
...
core.register_node("blocklife:furnace_active", apply_logger({
	description = S("Furnace"),
	tiles = {
		"blocklife_furnace_top.png", "blocklife_furnace_bottom.png",
		"blocklife_furnace_side.png", "blocklife_furnace_side.png",
		"blocklife_furnace_side.png",
		{
			name = "blocklife_furnace_front_active.png",
